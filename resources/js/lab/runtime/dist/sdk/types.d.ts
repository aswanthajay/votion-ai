...
export interface LabRuntimeOptions {
    /** Opt-in DeepThoughtEngine subsystem profiling. Disabled by default. */
     ...
     * from `@krikkit/deepthought/headless`.
     */
    headless?: boolean;
    /** URL of the deepthought service worker. Defaults to `/__deepthought_sw__.js`. */
    swUrl?: string;
    /**
    ...
    /** Show a small "deepthought" watermark link in preview iframes. Defaults to false. */
    watermark?: boolean;
