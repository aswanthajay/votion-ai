export declare const DEFAULT_SW_PATH = "/__krikkit_lab_sw__.js";
export declare const LAB_SW_PATH = "/__krikkit_lab_sw__.js";
export declare const LEGACY_SW_PATH = "/__deepthought_sw__.js";
/**
 * Headers for the deepthought service worker response.
 *
