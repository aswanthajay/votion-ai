// child_process polyfill -- exec, execSync, spawn, fork backed by LabShell.
// Integrates with MemoryVolume directly.

import { LabShell } from "../shell/shell-interpreter";
...
// runs command inline in the current worker via LabShell (NOT a child process).
...
export function exec(
  ...
  // run inline via LabShell -- only fork() gets a dedicated worker
