...
/** Real chokidar exports `FSWatcher`; fumadocs/vite call `new chokidar.FSWatcher(...)`. */
export const FSWatcher = PathWatcher;

export default { watch, PathWatcher, FSWatcher, setVolume };
