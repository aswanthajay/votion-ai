...
/** Node 20+ `buffer` exports File/Blob — Next edge middleware imports them. */
const BlobExport = globalThis.Blob;
const FileExport =
  typeof globalThis.File === "function"
    ? globalThis.File
    : class FilePolyfill extends BlobExport {
        name: string;
        lastModified: number;
        constructor(
          fileBits: BlobPart[],
...
export const Blob = BlobExport;
export const File = FileExport as typeof globalThis.File;

if (typeof globalThis.File === "undefined") {
  (globalThis as any).File = FileExport;
}
