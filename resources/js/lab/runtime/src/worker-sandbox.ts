// Krikkit Lab — dedicated Web Worker script sandbox
...
export class WorkerSandbox implements IScriptEngine {
  ...
  private endpoint: Remote<SandboxWorkerApi>;
  ...
  constructor(vol: MemoryVolume, cfg: EngineConfig = {}) {
    ...
    this.thread = spawnEngineWorker();

    this.endpoint = wrap<SandboxWorkerApi>(this.thread);
