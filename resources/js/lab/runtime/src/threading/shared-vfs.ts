// Krikkit Lab — SharedArrayBuffer-backed read-only VFS mirror.
...
export class SharedVFSController {
  ...
  // Torn reads under concurrent compaction are real; do not treat SharedVFS
  // as the primary read path without a per-entry seqlock.
