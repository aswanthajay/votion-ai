...
import {
  LAB_WASM_MODULE_DB,
  LEGACY_WASM_MODULE_DB,
} from "../internal/lab-keys";
import { openLabIdb } from "../internal/lab-idb";

const DB_NAME = LAB_WASM_MODULE_DB;
const LEGACY_DB_NAME = LEGACY_WASM_MODULE_DB;
...
function openDB(): Promise<IDBDatabase | null> {
  return openLabIdb(DB_NAME, LEGACY_DB_NAME, DB_VERSION, STORE_NAME);
}
