// Krikkit Lab — browser bundler for node_modules (esbuild-wasm).
...
const LAB_BUNDLE_CACHE_CAP = 24 * 1024 * 1024;
...
function cacheBundle(specifier: string, value: string): void {
  ...
  while (bundledModuleBytes > LAB_BUNDLE_CACHE_CAP && bundledModules.size > 1) {
